...
_app.initHelpers = function() {
    app.use(function(req, res, next) {
        ...
        _utils.loadHelpers(_utils.filesystem.appendSlash(__dirname)  + "helpers", req, res);
        _utils.loadHelpers(_utils.filesystem.appendSlash(_options.paths.library)  + "helpers", req, res);
...
_app.initModules = function() {
    ...
    var traverseModules = function(path) {
        ...
        {
            var config = require(path + "/config/navigation.js");
        ...
        {
            var config = require(path + "/config/routes.js");
